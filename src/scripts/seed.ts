...
async function seed() {
  ...
  const feedbackRows = [
    // --- Positive (4 rows — top-rated hotels, scores 4.5–5.0) ---
    {
      ...
      traveller_email: 'priya.sharma@corp.in',
      overall_score: 4.9,
      cleanliness_score: 5,
      service_score: 5,
      value_score: 5,
    ...
    },
    {
      ...
      hotel_id: HOTEL_IDS.grandRoyalBangalore,
      traveller_name: 'Arjun Mehta',
      traveller_email: 'arjun.mehta@corp.in',
      overall_score: 4.7,
      cleanliness_score: 5,
      service_score: 5,
      value_score: 4,
    ...
    },
    {
      ...
      traveller_name: 'Kavitha Nair',
      traveller_email: 'kavitha.nair@corp.in',
      overall_score: 4.8,
      cleanliness_score: 5,
      service_score: 5,
      value_score: 5,
    ...
    },
    {
      ...
      hotel_id: HOTEL_IDS.delhiResidency,
      traveller_name: 'Rohan Verma',
      traveller_email: 'rohan.verma@corp.in',
      overall_score: 4.5,
      cleanliness_score: 5,
      service_score: 5,
      value_score: 4,
    ...
    // --- Neutral/mixed (4 rows — stable hotels, scores 3.0–4.2) ---
    {
      ...
      traveller_name: 'Sneha Iyer',
      traveller_email: 'sneha.iyer@corp.in',
      overall_score: 3.4,
      cleanliness_score: 4,
      service_score: 3,
      value_score: 3,
    ...
    },
    {
      ...
      traveller_name: 'Amit Patel',
      traveller_email: 'amit.patel@corp.in',
      overall_score: 3.8,
      cleanliness_score: 4,
      service_score: 3,
      value_score: 4,
